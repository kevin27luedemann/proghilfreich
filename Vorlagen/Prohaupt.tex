...
\begin{document}
%Autor, etc.
\newcommand{\versuch}{Versuch 11}
\newcommand{\titel}{Messung großer Widerstände}
...
\newcommand{\durchfuehrungsdatum}{xx.xx.2014}
...
\begin{Large}
\begin{tabular}{ll}
Praktikanten: &  \praktikantA\footnotemark,\\
	      &  \praktikantB\footnotemark \\
             [0.3cm]
Gruppe: & \gruppe\\
	     [0.3cm]
